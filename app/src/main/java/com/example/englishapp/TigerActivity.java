...
public class TigerActivity extends Activity {
    ...
    private void goToTigerGif(){
        ImageButton goToDogGifButton = (ImageButton)findViewById(R.id.nextToTigerGif);
        goToDogGifButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(TigerActivity.this, Tiger_Gif_Activity.class));
            }
        });
    }

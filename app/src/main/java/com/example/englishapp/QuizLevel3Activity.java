...
public class QuizLevel3Activity extends Activity {
    ...
    String quizData[][] = {
            ...
            {"whatname", "is", "are", "where", "x"},
            {"whatyoudo", "student", "cat", "Table", "8 year old"},
            {"wherefrom", "Where", "What", "How", "Why"},
            {"whatcolor", "it is red", "Pig", "I'm Nam", "book"},
            {"spellname", "T-U-A-N", "I'm Nam", "Where", "Tiger"},
            {"whattime", "8 o'clock", "are", "how", "it's Monday"},
    ...
    public void showResult() {
        ...
        builder.setMessage(rightAnswerCount + " / 6");

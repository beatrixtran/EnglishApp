...
public class Crab_Gif_Activity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_crab__gif_);
    ...
    private void goToCrab(){
        ...
        goToCowButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(Crab_Gif_Activity.this, GoatActivity.class));
            }
        });
    }

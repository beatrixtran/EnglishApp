...
public class Pig_Gif_Activity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pig__gif_);
    ...
    private void goToCrab(){
        ...
        goToCowButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(Pig_Gif_Activity.this, GiraffeActivity.class));
            }
        });
    }

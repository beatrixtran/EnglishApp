...
public class Goat_Gif_Activity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_goat__gif_);
    ...
    private void goToCrab(){
        ...
        goToCowButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(Goat_Gif_Activity.this, FrogActivity.class));
            }
        });
    }

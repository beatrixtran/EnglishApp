...
public class Frog_Gif_Activity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_frog__gif_);
    ...
    private void goToCrab(){
        ...
        goToCowButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(Frog_Gif_Activity.this, PigActivity.class));
            }
        });
    }

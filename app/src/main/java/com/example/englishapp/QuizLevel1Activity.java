...
public class QuizLevel1Activity extends Activity {
    ...
    String quizData[][] = {
            ...
            {"bear", "Bear", "cow", "bow", "bag"},
            {"crab", "Crab", "Circle", "Table", "Cat"},
            {"hippo", "Hippo", "Pig", "Turtle", "Tiger"},
            {"chickens", "Chickens", "Pig", "Turtle", "Tiger"},
            {"frog", "frog", "Pig", "Turtle", "Tiger"},
            {"giraffe", "giraffe", "Lion", "cow", "Turtle"},
            {"pig", "pig", "Lion", "Bear", "Crab"},

            {"turtle", "Turtle", "Lion", "Table", "Crab"},
